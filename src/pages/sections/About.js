  ...
  return (
    <div className="w-11/12 py-10 mx-auto ">
      ...
      <p className="text-neutral-900 pl-16 w-8/12 mt-3">
        ...
        and understand my field. Always seek for new knowledge as well as best
        experience to develop my personal growth and skills. I use technologies
        that applicable in industry standard and can adapt to tech trends.
      </p>
    </div>
  );
};
