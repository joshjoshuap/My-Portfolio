...
const About = () => {
  return (
    <Section sectionTitle="My Story">
      <p className="mt-3 text-sm text-center indent-3 md:text-justify md:text-lg md:pl-5 md:mt-5 lg:text-xl xl:text-2xl lg:leading-relaxed text-neutral-900">
